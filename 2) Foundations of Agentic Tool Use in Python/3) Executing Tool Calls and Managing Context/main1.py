...
tool_schemas = [
    ...
    # TODO: Add the schema for the 'add' function here
    # Remember to match the parameter names (a, b) and types (number)
    # The schema should have: type, name, description, strict, and parameters
    {
        "type": "function",
        "name": "add",
    ...
    # TODO: Add the schema for the 'multiply' function here
    # Use the same structure as the add schema
    {
        "type": "function",
        "name": "multiply",
...
# Process the response: look for function calls in the output
for item in response.output:
    if item.type == "function_call":
        print(f"The model wants to call: {item.name}")

...
# TODO: Import get_db_session and pydantic_to_db from server.database
from server.database import get_db_session, pydantic_to_db
...
def agent_launch(payload: LaunchRequest, background_tasks: BackgroundTasks):
    ...
    # TODO: Convert initial_state to a database model with pydantic_to_db()
    # TODO: Add the database model to the session with session.add()

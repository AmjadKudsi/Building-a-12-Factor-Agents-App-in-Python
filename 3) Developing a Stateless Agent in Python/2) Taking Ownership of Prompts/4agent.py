...
# TODO: Import serialize_context_to_text from core.utils.context_serializer
...
class Agent:
    ...
    def _call_llm(self, context: List[Any]):
        # TODO: Call serialize_context_to_text(context) to transform the raw context
        ...
        print("\n" + "=" * 80)
        print("Serialized Context (Agent input):")
        print("=" * 80)
        print(serialized_context)
        print("=" * 80 + "\n")

        # TODO: Pass the serialized string as the input parameter instead of the raw context list
